...
class ScannerInterfaceView: UIView {
    ...
    private var _frameHeight: CGFloat = 200
    ...
    var frameHeight: CGFloat {
        ...
        set(newValue) {
            _frameHeight = CGFloat(truncating: newValue as NSNumber)
        }
    }
    
    func setFrameHeightWithNumber(_ value: NSNumber) {
        _frameHeight = CGFloat(truncating: value)
    }
